...
GAMES=("ALE/Pong-v5" "ALE/SpaceInvaders-v5" "ALE/Amidar-v5" "ALE/Freeway-v5" "ALE/Boxing-v5" "ALE/Seaquest-v5")  # Add more games as needed "ALE/Seaquest-v5" "ALE/Pong-v5"
