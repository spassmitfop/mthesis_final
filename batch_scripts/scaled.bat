...
set GAMES=ALE/Seaquest-v5 ALE/Pong-v5 ALE/SpaceInvaders-v5 ALE/Amidar-v5 ALE/Freeway-v5 ALE/Boxing-v5
REM 
...
set MASKED_WRAPPER=masked_dqn_bin_scaled
set EXP_NAME=bin_scaled_kr_0point87
